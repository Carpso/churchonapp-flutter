...
//
// Protomaps Basemap v4 "light" style layers, copied from the
// `vector_map_tiles_pmtiles` package (CC0 / public domain).
//
// Why a local copy: `ProtomapsThemes.lightV4()` hardcodes its glyph URL to
// protomaps.github.io and the package does NOT expose it. Keeping our own copy
// lets us point `glyphs` at our SELF-HOSTED fonts on R2
// (maps.churchonapp.com/fonts/{fontstack}/{range}.pbf) so map labels need no
// third-party dependency and work offline.
//
// To regenerate: copy the `themeLight` array from
//   vector_map_tiles_pmtiles/lib/src/themes/v4/light.dart
// ignore_for_file: prefer_single_quotes, require_trailing_commas

const List<Map<String, Object>> kProtomapsLightV4Layers =
[
  {
    "id": "background",
    "type": "background",
