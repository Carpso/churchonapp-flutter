...
//
// Protomaps Basemap v4 "dark" style layers, copied from the
// vector_map_tiles_pmtiles package (CC0 / public domain).
//
// Why a local copy: ProtomapsThemes.darkV4() hardcodes its glyph URL to
// protomaps.github.io and the package does NOT expose it. Keeping our own copy
// lets us point glyphs/sprites at our SELF-HOSTED assets on R2
// (maps.churchonapp.com/map-assets/...) so dark mode has no third-party
// dependency and works offline once cached.
//
// To regenerate: copy the themeDark array from
//   vector_map_tiles_pmtiles/lib/src/themes/v4/dark.dart
// ignore_for_file: prefer_single_quotes, require_trailing_commas

const List<Map<String, Object>> kProtomapsDarkV4Layers = [
  {
    "id": "background",
    "type": "background",
