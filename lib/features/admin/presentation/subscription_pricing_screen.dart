...
class _SubscriptionPricingScreenState extends ConsumerState<SubscriptionPricingScreen> {
  ...
  final _featureFields = [
    ...
    {'key': 'marketplace_book_fee_percent', 'label': 'Marketplace Book Fee % (e.g. 0.10 = 10%)', 'default': '0.10'},
    ...
    {'key': 'platform_theme_color', 'label': 'Platform Theme Color (hex, e.g. FFDA03 = sunflower yellow; blank = tenant colors)', 'default': 'FFDA03'},
