...
class LiveViewerHeatmapScreen extends StatefulWidget {
  const LiveViewerHeatmapScreen({super.key});

  @override
  State<LiveViewerHeatmapScreen> createState() => _LiveViewerHeatmapScreenState();
}

class _LiveViewerHeatmapScreenState extends State<LiveViewerHeatmapScreen> {
  int _refreshKey = 0;
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text("Heatmap refreshed"), duration: Duration(seconds: 1)),
              );
            },
          )
        ],
