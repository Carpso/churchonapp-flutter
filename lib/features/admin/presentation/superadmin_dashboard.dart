...
class SuperAdminDashboard extends ConsumerWidget {
  ...
  Widget _buildStatsGrid(ThemeData theme, _SuperStats stats) {
    ...
    return GridView.count(
      ...
      children: [
        _statCard(theme, "Tenants", "${stats.tenants}", LucideIcons.building, theme.primaryColor.withValues(alpha: 0.8)),
        _statCard(theme, "Total Users", _formatCompact(stats.totalUsers), LucideIcons.users, theme.primaryColor.withValues(alpha: 0.7)),
  ...
  List<Widget> _buildManagementTiles(BuildContext context, ThemeData theme) {
    return [
      _tile(context, theme, LucideIcons.home, "Congregation Management", "Onboard and audit Church branches", theme.primaryColor, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const CoaEmployeeDashboard()))),
      _tile(context, theme, LucideIcons.users, "Member Management", "Track your flock, verify baptisms & attendance", theme.primaryColor, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const MemberManagementScreen()))),
      ...
      _tile(context, theme, LucideIcons.banknote, "Church Auto-Payout", "Automatic treasurer payouts from church giving balances", theme.primaryColor, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ChurchPayoutScreen()))),
      ...
      _tile(context, theme, LucideIcons.users, "Employee Management", "Add staff, set salaries, manage departments", theme.primaryColor, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const EmployeeManagementScreen()))),
      ...
      _tile(context, theme, LucideIcons.penTool, "Writer Approvals", "Approve writer applications", theme.primaryColor, () => context.push('/writer-approvals')),
      ...
      _tile(context, theme, LucideIcons.car, "Carpso Driver Approvals", "Approve driver applications for Carpso Ride", theme.primaryColor, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const CarpsoDriverApprovalScreen()))),
      _tile(context, theme, LucideIcons.gift, "Promo Campaigns", "Discount codes, coin bonuses & promotions", theme.primaryColor, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const PromoCampaignScreen()))),
      ...
      _tile(context, theme, LucideIcons.shieldCheck, "AI Moderator", "AI Gatekeeper for social testimonies", theme.primaryColor, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const KingdomAIModeratorScreen()))),
      ...
      _tile(context, theme, LucideIcons.slidersHorizontal, "Feature Toggles", "Enable/disable 45+ features per tenant", theme.primaryColor, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const FeatureTogglesScreen()))),
      _tile(context, theme, LucideIcons.trendingUp, "Engagement Analytics", "Bible audio, podcast, Kids Zone & quiz metrics", theme.primaryColor, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const PlatformAnalyticsScreen()))),
      _tile(context, theme, LucideIcons.puzzle, "Integrations", "Configure third-party integrations", theme.primaryColor, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const IntegrationsScreen()))),
      ...
      _tile(context, theme, LucideIcons.building, "Tenant Lease Management", "Approve churches, extend trials, suspend tenants", theme.primaryColor, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const TenantLeaseManagementScreen()))),
