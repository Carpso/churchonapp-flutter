...
class KingdomLifeHubScreen extends StatelessWidget {
  const KingdomLifeHubScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Kingdom Life", style: TextStyle(fontWeight: FontWeight.bold)),
      ...
      body: ListView(
        ...
        children: [
          _buildHubItem(
            ...
            LucideIcons.radio,
            Colors.orange,
            () => Navigator.push(context, MaterialPageRoute(builder: (_) => const KingdomRadioScreen())),
          ),
          ...
          _buildHubItem(
            ...
            LucideIcons.flame,
            Colors.red,
            () => Navigator.push(context, MaterialPageRoute(builder: (_) => const TestimoniesScreen())),
          ),
          const SizedBox(height: 15),
          _buildHubItem(
            context,
