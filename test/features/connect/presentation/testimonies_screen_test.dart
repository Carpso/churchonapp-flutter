...
void main() {
  ...
  testWidgets('TestimoniesScreen renders', (WidgetTester tester) async {
    await tester.runAsync(() async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            testimonyStreamProvider.overrideWith((ref) => Stream.value(<Testimony>[])),
          ],
          child: const MaterialApp(
            home: TestimoniesScreen(),
          ),
        ),
      );
      await tester.pump();
    });
    expect(find.byType(TestimoniesScreen), findsOneWidget);
  });

  testWidgets('TestimoniesScreen shows title', (WidgetTester tester) async {
    await tester.runAsync(() async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
