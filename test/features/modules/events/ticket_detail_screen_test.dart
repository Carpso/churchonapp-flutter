...
void main() {
  ...
  final testEvent = ChurchEvent(
    ...
    attendeeCount: 10,
    category: 'Conference',
    organizerMomoPhone: '0970000000',
    organizerMomoName: 'Test Organizer',
  );

  testWidgets('Ticket detail screen renders without error', (tester) async {
    await tester.pumpWidget(
      ProviderScope(
        overrides: [],
        child: MaterialApp(
          home: TicketDetailScreen(event: testEvent),
        ),
      ),
    );
    await tester.pump();
  ...
  testWidgets('Ticket detail screen shows event title', (tester) async {
    await tester.pumpWidget(
      ProviderScope(
        overrides: [],
        child: MaterialApp(
